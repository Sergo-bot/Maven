...
@EnableWebMvc
public class MavenSpringConfig implements WebMvcConfigurer {
    @Override
    ...
    public DataSource dataSource() {
        ...
        return builder.setType(EmbeddedDatabaseType.H2).addScript("META-INF/ sql/schema.sql").addScript("META-INF/sql/data.sql").build();
    }
    @Bean
